...
import FunctionsWithCircularROIs as fp
from datetime import datetime
import tempfile
import BestImageFinderEndFace as bif


################# The only things ypu need to change ######################
# path to the images
mypath = r'G:\AI Engineering\Co-ops\Chitwan Singh\Image Characterization\Defect Testing\14100\End Face\Co-axial'
...
for i, imageName in enumerate(images, start=2):
    ...
    # Find ROIs
    rois = fp.calculate_circular_ROIs(imagePath)
